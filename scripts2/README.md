...
*000_process_data_adm2.R* & *000_process_data_adm1.R* 
...
*04.1_run_dlnm2x_confounderinteraction* This script allows inclusion of a second crossbasis for temperature.

*04.2_run_univariable_dlnm_confounderinteraction* This script allows inclusion interactions between temperature and the crossbasis.

*04.3_run_bivariable_dlnm_lag0Sensitivity*  This script allows inclusion of meteorological factors additionally across different lag times. 

## Running Models with Sensitivity Modifications ##
*05.1_run_bivariable_dlnm_GPSC_singleprovinces.R*
...
*05.4_run_bivariable_dlnm_spatialSensitivity.R*
...
## Running Models with outcome specific disease types (demographic, disease outcome, serotype) ##
