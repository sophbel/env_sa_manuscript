...
for(gp in 1:length(gpsc_vec_sub)){
  print(paste0("Running Models for: ",gpsc_vec_sub[gp]))
    ...
    interact_var = gpsc_vec_sub[gp]
        ...
        ############## SAVE FILES ##############################################
        write.table(mod_sum2, file=paste0("models/dlnms/bivariable/mod_gof_dlnm_",time,"_",space,"_",interact_var,"_bivariable_",max_lag,"_",endyear,"_cov2templag3humlag0.csv"), quote = FALSE, col.names = TRUE, row.names = TRUE, sep = ",")

  } ### end of loop through gpscs


if(interaction==TRUE){
write.table(rr_ratio_all, file=paste0("models/dlnms/bivariable/rr_ratio_all_",time,"_",space,"_allGPSCs_propprov_bivariable_",max_lag,"_",endyear,"_cov2templag3humlag0.csv"), quote = FALSE, col.names = TRUE, row.names = TRUE, sep = ",")
write.table(gpsc_results, file=paste0("models/dlnms/bivariable/gpsc_results_fits_",time,"_",space,"_allGPSCs_propprov_bivariable_",max_lag,"_",endyear,"_cov2templag3humlag0.csv"), quote = FALSE, col.names = TRUE, row.names = TRUE, sep = ",")
write.table(mod_sum_all, file=paste0("models/dlnms/bivariable/mod_gof_dlnm",time,"_",space,"_allGPSCs_propprov_bivariable_",max_lag,"_",endyear,"_cov2templag3humlag0.csv"), quote = FALSE, col.names = TRUE, row.names = TRUE, sep = ",")
}else{
  write.table(dlnm_results, file=paste0("models/dlnms/bivariable/nointeraction_results_fits_",time,"_",space,"_bivariable_",max_lag,"_",endyear,"_cov2templag3humlag0.csv"), quote = FALSE, col.names = TRUE, row.names = TRUE, sep = ",")
}
...
for(s in 1:length(st_vec)){
  m1 <- fread(file=paste0("models/dlnms/bivariable/nointeraction_results_fits_",st_vec[s],"_bivariable_",max_lag,"_",endyear,"_cov2lag0.csv"))
...
stlist <- list()
for(s in 1:length(st_vec)){
  m1 <- fread(file=paste0("models/dlnms/bivariable/nointeraction_results_fits_",st_vec[s],"_bivariable_",max_lag,"_",endyear,"_cov2templag0humlag3.csv"))
  m1$space_time <- st_vec[s]
  stlist[[s]] <- m1
}
...
stlist <- list()
for(s in 1:length(st_vec)){
  m1 <- fread(file=paste0("models/dlnms/bivariable/nointeraction_results_fits_",st_vec[s],"_bivariable_",max_lag,"_",endyear,"_cov2templag3humlag0.csv"))
  m1$space_time <- st_vec[s]
  stlist[[s]] <- m1
}
...
pdf(paste0("figures/figure3/pollutant_meteoconfounder_lagweekSensitivity_weeklyadm2.pdf"),width = 5,height=4)
(sens)
dev.off()
print(sens)
ggsave(paste0("figures/figure3/pollutant_meteoconfounder_lagweekSensitivity_weeklyadm2.png"),width = 5,height=4)
dev.off()
