...
cumspms2 <- tmppm2[which( tmppm2$lag=="lag3" & tmppm2$cov == "pm2p5"),c("cov2","var","cumrr","cumlowerCI_rr","cumupperCI_rr")]
cumspms2$perc_increase_above40 <- (cumspms2$cumrr / cumspms2$cumrr[(cumspms2$var == 40 & cumspms2$cov2 == "none")] - 1) * 100
cumspms2[which(cumspms2$cov2=="none"),]
cumspms2[which(cumspms2$cov2=="hurs"),]
...
cumspms10$perc_increase_above75 <- (cumspms10$cumrr / cumspms10$cumrr[(cumspms10$var == 75 & cumspms10$cov2 == "none")] - 1) * 100
...
cumsso2$perc_increase_above125 <- (cumsso2$cumrr / cumsso2$cumrr[(cumsso2$var == 130 & cumsso2$cov2 == "none")] - 1) * 100
cumsso2[which(cumsso2$cov2=="none"),]
cumsso2[which(cumsso2$var=="150"),]

### humidity numbers
## low humidity
highhursrisk <- tmphurs[which(tmphurs$cumlowerCI_rr>1 & tmphurs$cov2%in%c("none","pm2p5")),c("cov2","var","cumrr","cumlowerCI_rr","cumupperCI_rr")]
...
## WHOLE COUNTRY
m1 <- fread(file = paste0("/home/sbelman/Documents/env_sa_manuscript/models/dlnms/univariable/nointeraction_results_fits_weekly_adm1_8_2019.csv"))
