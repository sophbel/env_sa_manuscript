...
plot_hurs <- ggplot(tmphurs)+
  ...
  facet_wrap(.~lag_week, nrow = 1)+
  xlab("Percent")+
  theme(axis.text = element_text(size=13),axis.title=element_text(size=13), strip.text = element_text(size=13), axis.text.x = element_text(angle = 45,hjust=1, size=13), legend.position = "none")
...
pdf(paste0("/home/sbelman/Documents/env_sa_manuscript/figures/figure3/pm2p5pm10_weeklags_additive_sa_",space_time_str,".pdf"),width = 10,height=4)
(plot_pm2p5/ plot_pm10)
dev.off()
...
pdf(paste0("/home/sbelman/Documents/env_sa_manuscript/figures/figure3/so2_weeklags_additive_sa_",space_time_str,".pdf"),width = 10,height=2)
(plot_so2)
dev.off()
...
pdf(paste0("/home/sbelman/Documents/env_sa_manuscript/figures/figure3/pm2p5_cumulative_additive_sa_",space_time_str,".pdf"),width  =4.5,height=3.5)
print(plot_pm2p5_cum)
dev.off()

pdf(paste0("/home/sbelman/Documents/env_sa_manuscript/figures/figure3/so2_cumulative_additive_sa_",space_time_str,".pdf"),width  =4.5,height=3.5)
print(plot_so2_cum)
dev.off()

pdf(paste0("/home/sbelman/Documents/env_sa_manuscript/figures/figure3/pm10_cumulative_additive_sa_",space_time_str,".pdf"),width  =4.5,height=3.5)
print(plot_pm10_cum)
dev.off()

pdf(paste0("/home/sbelman/Documents/env_sa_manuscript/figures/figure3/absh_cumulative_additive_sa_",space_time_str,".pdf"),width  =4.5,height=3.5)
print(plot_absh_cum)
dev.off()

pdf(paste0("/home/sbelman/Documents/env_sa_manuscript/figures/figure3/hurs_cumulative_additive_sa_",space_time_str,".pdf"),width  =4.5,height=3.5)
print(plot_hurs_cum)
dev.off()

pdf(paste0("/home/sbelman/Documents/env_sa_manuscript/figures/figure3/tas_cumulative_additive_sa_",space_time_str,".pdf"),width  =4.5,height=3.5)
print(plot_temp_cum)
dev.off()

### save together
pdf(paste0("/home/sbelman/Documents/env_sa_manuscript/figures/figure3/cumulative_additive_sa_",space_time_str,".pdf"),width  =9,height=7)
