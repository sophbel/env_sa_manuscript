...
## which model reduces the effect the most
...
cumsso2 <- tmpso2[which( tmpso2$lag=="lag3" & tmpso2$cov == "so2"),c("cov2","var","cumrr","cumlowerCI_rr","cumupperCI_rr")]
...
pm25attr <- ggplot(obs) +
  ...
  theme_bw()+
    ...
    guides(color = guide_legend(override.aes = list(linetype = c("solid","dashed","solid"))),linetype = "none") +
  theme_minimal() +
  theme(
    axis.title.y.left   = element_text(color = "black"),
...
#### if we got the average down to 30ug/m3 these are the number of cases avoided 
