...
```{r}
## multiple outcomes
    dlnm_multiout_demog <- fread("/home/sbelman/Documents/env_sa_manuscript/models/dlnms/suboutcomes/demographic/dlnm_subsetoutcomes_results_fits_weekly_adm2_demographic_2019.csv")
    ...
    fits_age <- subset(fits, fits$GPSC%in%c("age_gt65","age_lt6","age_15t64","female_count")& fits$lag_num%in%seq(0,max_lag,1))
...
```{r}
  ...
  fits_age_cum$GPSC <- factor(fits_age_cum$GPSC, levels = c("age_lt6","age_15t64","age_gt65", "age_gt80","female_count"))
...
#### across lags
     ...
     fits_age_lag$GPSC <- factor(fits_age_lag$GPSC, levels = c("age_lt6","age_15t64","age_gt65", "age_gt80","female_count"))
